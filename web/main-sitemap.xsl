			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Ubicaciones del mapa del sitio - Distribuidora Geb-Bens</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Mapa del sitio XML - Distribuidora Geb-Bens</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>Archivo KML</h1>
															...
															<p>
									Este archivo KML ha sido generado por el <a href="https://rankmath.com/" target="_blank">plugin Net4SEO WordPress SEO</a>. Se usa para proporcionar a Google información de la ubicación.								</p>
					...
					<xsl:otherwise>
						...
						<div id="description">
							...
							<h1>Mapa del sitio XML</h1>
															...
															<p>
									Este mapa del sitio XML lo ha generado el plugin <a href="https://rankmath.com/" target="_blank">Net4SEO WordPress SEO</a>. Los motores de búsqueda como Google lo utilizan para rastrear y volver a rastrear entradas/páginas/productos/imágenes/archivos de tu web.								</p>
